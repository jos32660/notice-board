...
$(".navi-wrap > li").click(function(){
    if($(this).index() == 0) navChg("B");
    else if($(this).index() == 1) navChg("A");
    else if($(this).index() == 2) navChg("P");
    else navChg("V");
});

function navChg(type){
    if(type == 'B') {
        $(".nav").eq(0).addClass("nav-active");
        $(".nav").eq(1).removeClass("nav-active");
        $(".nav").eq(2).removeClass("nav-active");
        $(".nav").eq(3).removeClass("nav-active");
    }
    else if(type == 'A') {
        $(".nav").eq(0).removeClass("nav-active");
        $(".nav").eq(1).addClass("nav-active");
        $(".nav").eq(2).removeClass("nav-active");
        $(".nav").eq(3).removeClass("nav-active");
    }
    else if(type == 'P') {
